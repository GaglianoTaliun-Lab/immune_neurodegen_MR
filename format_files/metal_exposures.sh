...
#SBATCH --time=2:00:00
#SBATCH --array=2,4,6,8,10,12,14,16
...
trait_M=$(sed -n ${SLURM_ARRAY_TASK_ID}p ${project_dir}/gwas_sample_sizes_sexstr_leukocytes.tsv | awk '{print $1}')
trait_F=$(sed -n ${SLURM_ARRAY_TASK_ID2}p ${project_dir}/gwas_sample_sizes_sexstr_leukocytes.tsv | awk '{print $1}')
